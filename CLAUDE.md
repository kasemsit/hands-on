...
7. **เลขบท = ชื่อเรียกถาวร ไม่ใช่ลำดับการอ่าน** — ลำดับอยู่ใน `_quarto.yml`
   ...
   และ **เลขหัวข้อก็เป็นชื่อเรียกถาวรเหมือนกัน** — anchor `{#s47-8}` ผูกกับเลข
   ถ้าเปลี่ยนเลขหัวข้อต้องไล่แก้ลิงก์ที่ชี้มาด้วย (แก้ *ชื่อ* หัวข้อได้อิสระ)
   → เพราะแบบนี้ถึงไม่ใช้ anchor อัตโนมัติของ Quarto ที่สร้างจากชื่อหัวข้อ

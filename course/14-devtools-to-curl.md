...
## 14.5 หา flow ทั้งหมด ไม่ใช่แค่ request เดียว
...
(หรือถ้าคำนวณยากเกินไป ก็ถึงเวลาใช้ Playwright — บทที่ 17)

## 14.6 เครื่องมือช่วยอื่น ๆ
...
## 14.7 กรณี mobile app ของคุณเอง

DevTools ใช้ได้กับเบราว์เซอร์เท่านั้น สำหรับ native app ต้องใช้ proxy — บทที่ 19
...
8. ยิง `curl -s http://127.0.0.1:8080/spa` แล้วเทียบกับที่เห็นในเบราว์เซอร์
   ...
   นี่คือเหตุผลที่ต้องมีบทที่ 17

## แบบฝึกหัด

1. ทำตามข้อ 14.8 ทั้ง 8 ข้อ
2. เขียนลำดับ request ทั้งหมดของการ login ออกมาเป็นผัง (แบบในข้อ 14.5)
...
5. ใช้เทคนิคในข้อ 14.6: เอาคำสั่งที่ copy มา เปลี่ยน URL เป็น `/headers`

...
> หรือระบบที่คุณได้รับอนุญาตเป็นลายลักษณ์อักษรให้ทดสอบ (บทที่ 22)
...
> นี่คือเหตุผลที่บทที่ 7 บอกว่า certificate สำคัญ: การ "ดักดู" TLS ได้
...
## 19.5 Android 7+ — ปัญหาที่ต้องเจอแน่นอน
...
## 19.6 Certificate pinning — ปัญหาที่คุณสร้างเอง

ถ้าคุณทำ pinning ตามบทที่ 7 ไว้ **mitmproxy จะใช้ไม่ได้** (ซึ่งถูกต้องแล้ว —
...
ได้คำสั่งที่เอาไปเล่นซ้ำใน terminal ได้ทันที (เหมือน Copy as cURL ในบทที่ 14)

## 19.8 เขียนสคริปต์แต่ง traffic
...
**สถานการณ์ที่ควรทดสอบด้วยวิธีนี้** (อ้างอิงบทที่ 11-12):
...
## 19.10 ความปลอดภัย — ทำแล้วต้องเก็บกวาด
...
6. ตรวจ checklist ข้อ 19.10 ให้ครบหลังทดลองเสร็จ

...
## 20.1 สามบรรทัดแรกของทุกสคริปต์ {#s20-1}
...
## 20.3 ไฟล์ชั่วคราวและการเก็บกวาด {#s20-3}
...
## 20.4 อย่าใส่ความลับใน command line {#s20-4}
...
## 20.5 ตรวจผลลัพธ์ทุกครั้ง {#s20-5}
...
## 20.6 Retry ด้วย exponential backoff + jitter {#s20-6}
...
## 20.8 โครงสร้างสคริปต์ที่ดี {#s20-8}
...
## 20.9 เมื่อไรควรเลิกใช้ bash {#s20-9}
...
3. เขียน `retry_curl` ใน[ข้อ 20.6](#s20-6) แล้วทดสอบกับ URL ที่ไม่มีจริง
4. แก้ `pow-flow.sh` ให้จัดการกรณี 429 ตาม[ข้อ 20.7](#s20-7)
5. เขียนสคริปต์ตามโครงใน[ข้อ 20.8](#s20-8) ที่ login เข้า lab แล้วดึงรายชื่อหนังสือออกมา

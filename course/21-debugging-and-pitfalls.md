...
## 21.1 ขั้นตอนวินิจฉัยมาตรฐาน {#s21-1}
...
## 21.4 กับดักที่ทำให้เสียเวลามากที่สุด 10 อันดับ {#s21-4}
...
## 21.5 checklist เมื่อ "curl ไม่ได้ แต่เบราว์เซอร์ได้" {#s21-5}
...
## 21.6 Debug ฝั่ง server (API ของคุณเอง) {#s21-6}
...
## 21.7 เมื่อทุกอย่างดูถูกแต่ยังพัง {#s21-7}
...
1. ทำให้แต่ละอาการในหัว[ข้อ 21.2](#s21-2) เกิดขึ้นจริงกับ lab server อย่างน้อย 5 อย่าง

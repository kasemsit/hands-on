...
## 23.4 เอกสารมาตรฐานและ cheat sheet (ฟรีทั้งหมด) {#s23-4}
...
## 23.7 เส้นทางต่อจากคอร์สนี้ {#s23-7}
...
5. เอา checklist ใน[บทที่ 11.11](11-mobile-api-auth-design.md#s11-11) มาตรวจ API ของคุณ แล้วเขียนรายการสิ่งที่ต้องแก้

...
## 24.2 ทำไมถึงพบบ่อยมากใน mobile API
...
## 24.4 วิธีแก้: ตรวจความเป็นเจ้าของทุกครั้ง
...
## 24.5 วิธีที่ทนทานกว่า: query ให้ปลอดภัยตั้งแต่ต้น
...
## 24.6 BOLA ซ่อนอยู่ที่ไหนได้อีก
...
## 24.8 ญาติของ BOLA ที่ควรรู้จักด้วย
...
3. รันสคริปต์ทดสอบในข้อ 24.10 แล้วยืนยันว่า v1 fail และ v2 pass

...
> ([บทที่ 20.4](20-shell-scripting-for-curl.md)) โปรเจกต์นี้มี `.gitignore` เตรียมไว้ให้แล้ว
...
นี่คือจุดที่คนทำ API พลาดกันบ่อยที่สุด และเชื่อมกับ[บทที่ 25.8](25-input-validation-and-injection.md) โดยตรง

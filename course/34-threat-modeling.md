...
> บทที่ 11, 24, 25 ให้ checklist ไว้เยอะ — แต่ **checklist มีวันหมดอายุ**
> และมันไม่ครอบคลุมระบบเฉพาะของคุณ
>
> บทนี้สอนวิธีสร้าง checklist ของตัวเอง

## 34.1 ทำไม checklist อย่างเดียวไม่พอ
...
## 34.3 ขั้นที่ 1 — วาดว่าข้อมูลไหลไปไหน
...
| **แอป → API** | **แอปอยู่บนเครื่องผู้ใช้ = ศัตรูอาจคุมมันอยู่** (บทที่ 15.8) |
| API → DB | injection (บทที่ 25.2) |
| **ภายนอก → API** (webhook) | ใครก็ยิงได้ (บทที่ 13) |
| API → ภายนอก | SSRF (บทที่ 25.4) |

> **ภัยเกือบทั้งหมดเกิดที่เขตแดนพวกนี้** — วาดให้ครบแล้วคุณจะรู้ว่าต้องตรวจตรงไหน

## 34.4 ขั้นที่ 2 — STRIDE
...
## 34.5 ขั้นที่ 3 — จัดลำดับ แล้วตัดสินใจ
...
## 34.6 คิดแบบผู้โจมตี — attack tree
...
| `/api/v1/orders` ไม่เช็ค owner | I | ❌ **โดยเจตนา** ไว้สอนบทที่ 24 |
| `/api/fetch` ไม่ตรวจ URL | I | ❌ **โดยเจตนา** ไว้สอนบทที่ 25 |
...
## 34.8 ทำเมื่อไร และใช้เวลาเท่าไร
...
**เก็บไว้ใน git ข้างโค้ด** (บทที่ 30) เป็นไฟล์ `THREATS.md` ธรรมดา
จะได้ทบทวนและเห็นว่าเปลี่ยนไปอย่างไร

## 34.9 กับดักของการทำ threat modeling
...
6. ทำแบบเดียวกับ lab server แล้วเทียบกับตารางในข้อ 34.7 — เจออะไรที่ผมไม่ได้ลิสต์ไหม
7. ถามคำถามยาก: **ถ้าคุณเป็นผู้โจมตีที่มีเวลา 1 สัปดาห์และรู้ว่าระบบคุณเขียนด้วยอะไร
   คุณจะเริ่มจากตรงไหน**

***
[⬅ ความปลอดภัยของระบบ AI](52-ai-system-security.md) · [สารบัญ](../README.md) · [จริยธรรมและขอบเขต ➡](22-ethics-and-limits.md)

...
| **แอป → API** | **แอปอยู่บนเครื่องผู้ใช้ = ศัตรูอาจคุมมันอยู่** ([บทที่ 15.8](15-captcha-and-antibot.md)) |
| API → DB | injection ([บทที่ 25.2](25-input-validation-and-injection.md)) |
| **ภายนอก → API** (webhook) | ใครก็ยิงได้ ([บทที่ 13](13-webhooks-and-hmac.md)) |
| API → ภายนอก | SSRF ([บทที่ 25.4](25-input-validation-and-injection.md)) |

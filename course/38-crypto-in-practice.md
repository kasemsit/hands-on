...
## 38.2 แผนที่: อยากได้อะไร ใช้อะไร
...
## 38.3 Hash — และความเข้าใจผิดที่อันตรายที่สุด
...
**สองกฎที่ห้ามลืม** (จาก[บทที่ 13.3](13-webhooks-and-hmac.md)):
...
## 38.5 Symmetric — กุญแจเดียว เข้าและถอด
...
## 38.7 ความสุ่ม — จุดที่พังบ่อยและเงียบ
...
## 38.8 การจัดการกุญแจ — ส่วนที่ยากที่สุด
...
| **อย่าเก็บในโค้ด** | secret manager ([บทที่ 28.10](28-observability-and-deployment.md)) |
| **หมุนได้โดยไม่ downtime** | รองรับสองกุญแจพร้อมกันช่วงเปลี่ยนผ่าน |
| **มี `kid`** | บอกว่าใช้กุญแจใบไหน ([บทที่ 10.3](10-jwt-deep-dive.md)) |
...
ค่อยเอากุญแจเก่าออก (หลักการเดียวกับ backup pin ใน[บทที่ 7.6](07-tls-https.md) และ webhook
secret ใน[บทที่ 13.6](13-webhooks-and-hmac.md))

## 38.9 ข้อผิดพลาดที่พบบ่อยที่สุด
...
## 38.10 Post-quantum — ต้องกังวลตอนนี้ไหม
...
**รอ library รองรับ อย่าเอามาใช้เองตอนนี้** (กลับไปที่กฎข้อ 38.1)
...
- [ ] TLS 1.2 ขั้นต่ำ ([บทที่ 7.8](07-tls-https.md))

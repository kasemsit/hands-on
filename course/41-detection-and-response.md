...
([บทที่ 34.4](34-threat-modeling.md)) สำคัญ

| แหล่ง log | ตอบคำถามอะไร |
|-----------|--------------|
| **auth log** (`/var/log/auth.log`) | ใครล็อกอิน สำเร็จ/ล้มเหลว |
| **application log** ([บทที่ 28.2](28-observability-and-deployment.md)) | ใครทำอะไรในระบบ |
| **web/access log** | request อะไรเข้ามาบ้าง |
| **audit log** (`auditd`) | ใครแตะไฟล์ไหน รันคำสั่งอะไร |
| **network flow** | เครื่องไหนคุยกับใคร |
| **DNS log** | เครื่องถามหาโดเมนอะไร (จับ C2 — [บทที่ 39.6](39-how-malware-works.md)) |
...
([บทที่ 12.9](12-api-design-practices.md)) ไม่งั้นเรียงลำดับเหตุการณ์ข้ามเครื่องไม่ได้
...
โยงกับ[บทที่ 28.6](28-observability-and-deployment.md) — **alert ที่ดีต้องมีคนต้องลงมือทำ**
...
- [ ] มี `security.txt` ให้คนภายนอกแจ้งเหตุได้ ([บทที่ 22.6](22-ethics-and-limits.md))

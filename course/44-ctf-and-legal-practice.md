...
> [บทที่ 22](22-ethics-and-limits.md) บอกว่า **อะไรที่ทำไม่ได้** บทนี้ตอบว่า **แล้วฝึกที่ไหนได้บ้าง**
>
> เพราะทักษะในเล่มนี้ต้องฝึกกับเป้าจริงถึงจะขึ้น — และมีที่ให้ฝึก
> อย่างถูกกฎหมายเยอะกว่าที่คนคิดมาก

## 44.1 เส้นแบ่งที่ต้องชัดในหัวก่อน {#s44-1}
...
## 44.2 สนามฝึกที่เปิดให้ฟรี {#s44-2}
...
>
> ต่อยอดจาก[บทที่ 24](24-authorization-and-bola.md)-25 ของเล่มนี้ได้ตรง ๆ

## 44.3 CTF — ฝึกอะไร และไม่ได้ฝึกอะไร {#s44-3}
...
## 44.4 Bug bounty — ของจริงที่ถูกกฎหมาย {#s44-4}
...
| ✅ ฝึกเขียนรายงาน (ทักษะที่ขาดที่สุด — [บทที่ 43](43-security-roles-and-paths.md)) |
| ❌ อย่าคาดหวังเป็นรายได้หลักในปีแรก |

**เริ่มที่โปรแกรมใหม่หรือ VDP ที่ยังไม่มีคนแห่ไป** มีโอกาสเจอมากกว่ามาก

## 44.5 เจอช่องโหว่โดยบังเอิญ — ทำอย่างไร {#s44-5}

เกิดขึ้นได้จริง เช่นแก้ URL ตัวเองแล้วเห็นข้อมูลคนอื่น ([บทที่ 24](24-authorization-and-bola.md))
...
## 44.6 สร้าง portfolio จากการฝึก {#s44-6}
...
| **home lab ที่มีเอกสาร** | ⭐⭐⭐⭐ | [บทที่ 45](45-home-lab.md) |
| อันดับใน CTF | ⭐⭐⭐ | การแข่ง |
| cert | ⭐⭐ | [บทที่ 43.4](43-security-roles-and-paths.md#s43-4) |
...
1. ทำแล็บของ PortSwigger หมวด **Access control** ให้ครบ
   แล้วเทียบกับที่เรียนใน[บทที่ 24](24-authorization-and-bola.md)

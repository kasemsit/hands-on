...
| **แล็บไม่ควรต่อเน็ตโดยไม่จำเป็น** | กัน C2 ติดต่อกลับ (บทที่ 39) |
...
Docker แชร์ kernel กับ host (บทที่ 36) — **ไม่พอสำหรับรันมัลแวร์**
งานแบบนั้นต้อง VM
...
>
> มัลแวร์ส่วนใหญ่ไม่ทำอะไรถ้าต่อเน็ตไม่ได้ (บทที่ 39.4)
...
ถ้าจะฝึกเนื้อหาบทที่ 46-52 ต้องการอีกแบบหนึ่ง
...
**ตั้ง k3s + HAMi บนเครื่องเดียวเพื่อฝึกบทที่ 49:**
...
> เป็นซอฟต์แวร์ล้วน ไม่เลือกรุ่นการ์ด (บทที่ 49.3)
...
**ทำให้ทุกอย่างสร้างใหม่ได้จากไฟล์** (บทที่ 30) — ถ้าแล็บพัง

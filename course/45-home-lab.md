...
## 45.1 ระดับของห้องแล็บ — เริ่มจากที่ถูกที่สุด {#s45-1}
...
## 45.2 กฎความปลอดภัยที่ห้ามละเมิด {#s45-2}
...
## 45.3 ระดับ 0 — Docker Compose ใน 5 นาที {#s45-3}
...
## 45.4 ระดับ 1 — VM สำหรับงานที่ต้องแยกจริง {#s45-4}
...
>
> มัลแวร์ส่วนใหญ่ไม่ทำอะไรถ้าต่อเน็ตไม่ได้ ([บทที่ 39.4](39-how-malware-works.md#s39-4))
...
## 45.5 แล็บสำหรับ GPU / AI (ส่วนที่ 8) {#s45-5}
...
> เป็นซอฟต์แวร์ล้วน ไม่เลือกรุ่นการ์ด ([บทที่ 49.3](49-gpu-on-containers-and-k8s.md#s49-3))

## 45.6 ทำให้แล็บมีค่าตอนสัมภาษณ์ {#s45-6}
...
## 45.7 Checklist ก่อนรันอะไรที่น่าสงสัย {#s45-7}
...
1. สร้าง `lab-compose.yml` ใน[ข้อ 45.3](#s45-3) แล้วยืนยันว่า container
...
5. ติดตั้ง k3s + HAMi ตาม[ข้อ 45.5](#s45-5) แล้วสร้าง pod ที่จำกัด VRAM 4 GB

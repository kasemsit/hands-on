...
> เป็นต้นทุนที่ต้องนับตอนวางแผนห้องแล็บ (บทที่ 49)
>
> **ตอนคุยกับผู้ขายให้ถามว่าโควตาที่เสนอมานับรวม context นี้หรือยัง**

## 47.2 น้ำหนักโมเดล — ตัวเลขง่ายที่สุด
...
## 47.4 สูตร KV cache — หัวใจของทั้งบท
...
| kv_heads | 8 | **KV head (ไม่ใช่ 32!)** — ดูข้อ 47.5 |
...
## 47.5 GQA — ทำไม kv_heads ถึงน้อยกว่า heads
...
## 47.6 ประกอบทุกอย่าง — เสิร์ฟได้กี่คน
...
## 47.7 ตารางที่เปลี่ยนวิธีตัดสินใจ
...
## 47.8 เมื่อ VRAM ไม่พอ — 5 ทางแก้ เรียงตามผลกระทบ
...
## 47.9 activation และ prefill — ที่คนลืม
...
> (นี่คือเหตุผลที่ `--gpu-memory-utilization` ของ vLLM ไม่ควรตั้ง 1.0 — บทที่ 48)

## 47.10 ทำไมการคำนวณนี้ยังไม่ใช่ทั้งหมด
...
## 47.11 สรุปเป็นขั้นตอนที่ใช้ได้จริง

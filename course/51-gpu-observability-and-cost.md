...
**เก็บ percentile ไม่ใช่ค่าเฉลี่ย** ([บทที่ 28.4](28-observability-and-deployment.md)) — p50, p95, p99
...
> ไม่ใช่ด้วยการซื้อการ์ดเพิ่ม ([บทที่ 49.1](49-gpu-on-containers-and-k8s.md))
...
- [ ] **quantize แล้วหรือยัง** — int8 ให้พื้นที่เพิ่มเท่าตัว ([บทที่ 47.8](47-gpu-memory-and-kv-cache.md))

...
## 52.1 พื้นผิวโจมตีที่เพิ่มขึ้นมา
...
## 52.6 ต้นทุนเป็นช่องโหว่ชนิดหนึ่ง
...
## 52.7 Checklist ก่อนเปิดให้คนอื่นใช้
...
- [ ] เลือกกลไกแบ่ง GPU ให้ตรงกับระดับความไว้ใจของผู้ใช้ (ข้อ 52.5)
...
***
[⬅ วัดผล GPU และคิดต้นทุนให้เป็น](51-gpu-observability-and-cost.md) · [สารบัญ](../README.md) · [Threat modeling ➡](34-threat-modeling.md)
